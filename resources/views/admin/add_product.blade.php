        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    ...
                    <form role="form" id="product-form" role="form" method="POST" action="/save_product"
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="5" class="form-control" id="product_desc" name="product_desc"
                                placeholder="Description of product"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="product_content">Nội dung sản phẩm</label>
                            <textarea style="resize: none" rows="5" class="form-control" id="product_content" name="product_content"
                                placeholder="Content of product"></textarea>
                        </div>
                        <div class="form-group">
